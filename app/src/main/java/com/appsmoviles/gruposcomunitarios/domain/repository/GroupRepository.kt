...
interface GroupRepository {
    ...
    suspend fun getSubscribedGroups(userId: String): Flow<Res<List<Group>>>
    suspend fun getGroupsWithRole(username: String): Flow<Res<List<Group>>>
    suspend fun subscribeToGroup(groupId: String, userId: String): Flow<Res<Nothing>>
    suspend fun unsubscribeToGroup(groupId: String, userId: String): Flow<Res<Nothing>>
}